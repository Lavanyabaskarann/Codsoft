...
contactlist = [
    ['Jai kumar','9941003874'],
    ['Raj kumar', '9912345678'],
    ['Surya kumar', '9921344567'],
    ['Surendar kumar','99651225674 '],
    ['Pritish kumar', '9987654323'],
    ['Nandha kumar', '9987654324'],
    ['Dharshini', '8828374657'],
    ['Shamitha', '9987651209'],
    ]
...
def UpdateDetail():
    if Name.get() and Number.get():
        ...
        if len(select.curselection()) == 0:
            ...
            message1 = """To Load all the information of \n
